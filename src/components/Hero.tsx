...
export default function Hero() {
  ...
  const float2Y = useTransform(scrollYProgress, [0, 1], ["0%", "-20%"]);
  ...
  return (
    ...
    >
      <div className="absolute inset-0 bg-gradient-to-br from-primary/[0.03] via-transparent to-accent/[0.03] dark:from-primary/[0.06] dark:via-transparent dark:to-accent/[0.04] pointer-events-none" />
      ...
      <motion.div
        style={{ y: float2Y, opacity }}
        className="hidden lg:block absolute bottom-[18%] right-[22%] w-[240px] h-[180px] pointer-events-none z-10"
      >
        <div
          className="relative w-full h-full rounded-2xl overflow-hidden shadow-2xl shadow-primary/20 dark:shadow-accent/10 animate-float"
          ...
          <div className="max-w-2xl lg:max-w-xl">
            ...
            >
              <span className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-accent/10 dark:bg-accent/15 text-accent text-sm font-medium mb-6 border border-accent/20">
                ...
                Admissions Open &mdash; Session 2025-2026
              </span>
            </motion.div>
            ...
            >
              ...
              across Karachi &mdash; blending quality education with Islamic
              values.
            </motion.p>
            ...
            >
              <Link
                href="/admissions"
                className="inline-flex items-center justify-center gap-2 px-8 py-4 bg-primary text-cream font-semibold rounded-full hover:bg-primary-light dark:hover:bg-primary/80 transition-all shadow-lg shadow-primary/20 dark:shadow-primary/10 active:scale-[0.97]"
              >
                Apply for Admission
                <svg
                  className="w-4 h-4"
              ...
              <Link
                href="/about"
                className="inline-flex items-center justify-center gap-2 px-8 py-4 text-primary-dark dark:text-cream font-semibold rounded-full border border-primary/10 dark:border-cream/10 hover:bg-white/50 dark:hover:bg-white/5 transition-all backdrop-blur-sm active:scale-[0.97]"
              >
                Explore More
              </Link>
            </motion.div>
